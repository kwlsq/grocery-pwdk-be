    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/**", "/api/v1/products/public/**", "/api/v1/products/**", "/api/v1/products/public/categories" ,"/api/v1/cart-items/**", "/api/v1/store", "/api/v1/warehouse/*", "/api/v1/images/**", "/api/v1/users/**").permitAll()
